...
if (!class_exists('IchHabRecht\\TestingFramework\\Bootstrap\\BootstrapFactory')) {
    require __DIR__ . '/../../../../autoload.php';
}

call_user_func(function () {
    $bootstrap = \IchHabRecht\TestingFramework\Bootstrap\BootstrapFactory::createBootstrapInstance();
