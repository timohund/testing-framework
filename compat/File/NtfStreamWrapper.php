...
class NtfStreamWrapper
{
    ...
    {
        trigger_error('The nft scheme is deprecated and will be removed with testing-framework 3.0. Please change your code to use tf scheme instead.', E_USER_DEPRECATED);
