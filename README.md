...
[![Latest Stable Version](https://img.shields.io/packagist/v/ichhaberecht/testing-framework.svg)](https://packagist.org/packages/ichhaberecht/testing-framework)
[![Build Status](https://img.shields.io/travis/IchHabRecht/testing-framework/master.svg)](https://travis-ci.org/IchHabRecht/testing-framework)
...
```bash
$ composer require --dev ichhaberecht/testing-framework
```
...
Inherit your test class from `\IchHabRecht\TestingFramework\TestCase\UnitTestCase`.

To execute the unit tests of your extension run

```bash
$ vendor/bin/phpunit -c vendor/ichhaberecht/testing-framework/res/Configuration/UnitTests.xml \
    typo3conf/ext/example_extension/Tests/Unit
```

#### ViewHelper

For an easy way to test your Fluid ViewHelper you can inherit the test class from `\IchHabRecht\TestingFramework\TestCase\ViewHelperBaseTestcase`.
...
Inherit your test class from `\IchHabRecht\TestingFramework\TestCase\FunctionalTestCase`.

To execute the functional tests of your extension run

```bash
$ vendor/bin/phpunit -c vendor/ichhaberecht/testing-framework/res/Configuration/FunctionalTests.xml \
    typo3conf/ext/example_extension/Tests/Functional
```

#### Database fixtures

The ichhaberecht/testing-framework ships database fixtures for several TYPO3 CMS core database tables:
...
The ichhaberecht/testing-framework ships an own TypoScript file for supporting frontend requests out of the box.
...
```php
// Setup the page with uid 1 and include tf and own TypoScript
$this->setUpFrontendRootPage(
    1,
    array(
        'tf://TypoScript/JsonRenderer.ts',
